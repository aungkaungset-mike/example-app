...
@section('admin')
  ...
  <div class="mb-3">
    ...
    <input type="file" name = "brand_image" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value = "">
  ...
  <div class="form-group">
      <img src="{{ asset($brands->brand_image) }}" style="height: 400px; height: 200px; " alt="">
  </div>
